package com.dmm.middleware.dynamic.thread.pool.trigger;

import com.alibaba.fastjson.JSON;
import com.dmm.middleware.dynamic.thread.pool.sdk.domain.model.entity.ThreadPoolConfigEntity;
import com.dmm.middleware.dynamic.thread.pool.types.Response;
 ...
 * @author Mean
 * @date 2025/1/4 21:08
 * @description DynamicThreadPoolController
 */
@Slf4j
@RestController()
@CrossOrigin("*")
...
public class DynamicThreadPoolController {
	...
	public Response<Boolean> updateThreadPoolConfig(@RequestBody ThreadPoolConfigEntity request) {
		try {
			...
			// 创建topic后发送消息，应用中的线程池的配置修改由监听器实现
